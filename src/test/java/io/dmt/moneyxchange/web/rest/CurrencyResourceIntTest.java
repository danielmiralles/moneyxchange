...
public class CurrencyResourceIntTest {
    ...
    private static final Boolean UPDATED_SYMBOL_LEFT = true;
    ...
    public void createCurrency() throws Exception {
        ...
        assertThat(testCurrency.isSymbolLeft()).isEqualTo(DEFAULT_SYMBOL_LEFT);
    ...
    @Test
    @Transactional
    public void checkSymbolLeftIsRequired() throws Exception {
        int databaseSizeBeforeTest = currencyRepository.findAll().size();
        // set the field null
        currency.setSymbolLeft(null);
    ...
    public void getAllCurrencies() throws Exception {
        ...
        restCurrencyMockMvc.perform(get("/api/currencies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].symbolLeft").value(hasItem(DEFAULT_SYMBOL_LEFT.booleanValue())))
    ...
    public void getCurrency() throws Exception {
        ...
        restCurrencyMockMvc.perform(get("/api/currencies/{id}", currency.getId()))
            ...
            .andExpect(jsonPath("$.symbolLeft").value(DEFAULT_SYMBOL_LEFT.booleanValue()))
    ...
    @Test
    @Transactional
    public void getAllCurrenciesBySymbolLeftIsEqualToSomething() throws Exception {
        // Initialize the database
        currencyRepository.saveAndFlush(currency);

        // Get all the currencyList where symbolLeft equals to DEFAULT_SYMBOL_LEFT
        defaultCurrencyShouldBeFound("symbolLeft.equals=" + DEFAULT_SYMBOL_LEFT);

        // Get all the currencyList where symbolLeft equals to UPDATED_SYMBOL_LEFT
        defaultCurrencyShouldNotBeFound("symbolLeft.equals=" + UPDATED_SYMBOL_LEFT);
    }

    @Test
    @Transactional
    public void getAllCurrenciesBySymbolLeftIsInShouldWork() throws Exception {
        // Initialize the database
        currencyRepository.saveAndFlush(currency);

        // Get all the currencyList where symbolLeft in DEFAULT_SYMBOL_LEFT or UPDATED_SYMBOL_LEFT
        defaultCurrencyShouldBeFound("symbolLeft.in=" + DEFAULT_SYMBOL_LEFT + "," + UPDATED_SYMBOL_LEFT);

        // Get all the currencyList where symbolLeft equals to UPDATED_SYMBOL_LEFT
        defaultCurrencyShouldNotBeFound("symbolLeft.in=" + UPDATED_SYMBOL_LEFT);
    }

    @Test
    @Transactional
    public void getAllCurrenciesBySymbolLeftIsNullOrNotNull() throws Exception {
        // Initialize the database
        currencyRepository.saveAndFlush(currency);

        // Get all the currencyList where symbolLeft is not null
        defaultCurrencyShouldBeFound("symbolLeft.specified=true");

        // Get all the currencyList where symbolLeft is null
        defaultCurrencyShouldNotBeFound("symbolLeft.specified=false");
    }
    ...
    public void updateCurrency() throws Exception {
        ...
        assertThat(testCurrency.isSymbolLeft()).isEqualTo(UPDATED_SYMBOL_LEFT);
